...
if($requesttype=="add"){
	$queryinitialcount = "Select count(*) as cnt from tw_company_address where company_id = '".$company_id."'";
	...
	$retVal1 = $sign->FunctionOption($qry1,$Status,'address_type_value','id');
		...
		$qry = "SELECT address_line1,address_line2,location,pincode,city,state,country,google_map,public_visible,default_address,address_type FROM tw_company_address WHERE id = '".$requestid."' ";
                ...
                <div class="card-body">
                  ...
                  <div class="forms-sample">
                   <div class="form-group row">
					  <label for="ContactField" class="col-sm-3 col-form-label">Address Type<span class="text-danger">*</span></label>
					  <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                      <label for="AddressLine1" class="col-sm-3 col-form-label">Address Line 1<span class="text-danger">*</span></label>
                      <div class="col-sm-9">
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="number"  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==6) return false;" class="form-control form-control-sm" maxlength="6" id="txtPincode" onchange="myFunction(this.value)" value="<?php echo $pincode; ?>" placeholder="Pincode">
                      </div>
                    </div>
					<div class="form-group row">
					...
					<div class="form-group row">
                      <label for="Country" class="col-sm-3 col-form-label">Country<span class="text-danger">*</span></label>
                      <div class="col-sm-9">
					...
					<div class="form-group row">
                      <label for="GoogleMap" class="col-sm-3 col-form-label">Google Map (Optional)<span class="text-danger"></span></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" maxlength="100" id="txtGoogleMap" value="<?php echo $google_map; ?>" placeholder="Google Map">
                      </div>
                    </div>
  ...
  function adddata(){
	  if(!validateBlank($("#txtAddressLine1").val())){
			...
			setErrorOnBlur("txtPincode");
			  ...
			  //--Default Address
			  var valquery = "Update tw_company_address set default_address='false' where company_id='"+valcompany_id+"'";
			  $.ajax({
				type:"POST",
