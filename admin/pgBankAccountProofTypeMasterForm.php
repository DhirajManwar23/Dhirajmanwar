...
$bank_account_proof_type_value = "";
$priority = ""; 
$description = "";
$visibility = "";
if($requesttype=="edit"){
	
	$qry = "SELECT bank_account_proof_type_value,priority,description,visibility from tw_bank_account_proof_type_master WHERE id = ".$id." ";
	$retVal = $sign->FunctionJSON($qry);
	$decodedJSON = json_decode($retVal);
	$bank_account_proof_type_value = $decodedJSON->response[0]->bank_account_proof_type_value;
...
<title>Trace Waste | Bank Account Proof Type Master</title>
<!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
					<h4 class="card-title">Bank Account Proof Type Master</h4>
					<div class="forms-sample">
						<div class="form-group">
							<label for="txtbankaccountprooftype">Bank Account Proof Type <code>*</code></label>
							<input type="text" class="form-control" id="txtbankaccountprooftype" maxlength="20" value="<?php echo $bank_account_proof_type_value; ?>" placeholder="Bank Account Proof Type" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="txtDescription" maxlength="5000" rows="4" placeholder="Description"><?php echo $description; ?></textarea>
						</div>
						<div class="form-group">
...
function addrecord(){
		...
		if(!validateBlank($("#txtbankaccountprooftype").val())){
		setErrorOnBlur("txtbankaccountprooftype");
		}
		...
		setErrorOnBlur("txtDescription");
			...
			$.ajax({
			type:"POST",
			url:"apiAddBankAccountProofTypeMaster.php",
			data:{bankaccountprooftype:$("#txtbankaccountprooftype").val(),priority:$("#txtPriority").val(),description:$("#txtDescription").val(),visibility:$('#chkVisibility').prop('checked')},
			success:function(response){
				...
				if($.trim(response)=="Success"){			
						if(valrequesttype=="add"){
							...
							showAlertRedirect("Success","Record Added Successfully","success","pgBankAccountProofTypeMaster.php");
							
							}
						else{
							$('#btnAddrecord').html('Update Record');
							showAlertRedirect("Success","Record Updated Successfully","success","pgBankAccountProofTypeMaster.php");
							
						}
						$("#txtbankaccountprooftype").val("");
						$("#txtPriority").val("");
						$("#txtDescription").val("");
