                ...
                <div class="card-body">
                  ...
                  <div class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtContactType" maxlength="20" value="<?php echo $contact_type ?>" placeholder="Contact Type"/>
                    </div>
					<div class="form-group" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtIcon" maxlength="20" value="<?php echo $contact_icon; ?>"  placeholder="Icon" />
                    </div>
                    <div class="form-group">
...
function addrecord(){
		...
		if(!validateBlank($("#txtContactType").val())){
			setErrorOnBlur("txtContactType");
		  }
		  else if(!validateBlank($("#txtIcon").val())){
		  setErrorOnBlur("txtIcon");
		  } 
				...
				success:function(response){
					...
					if($.trim(response)=="Success"){
						if(valrequesttype=="add"){
							...
							showAlertRedirect("Success","Record Added Successfully","success","pgContactFieldMaster.php");
							}
						else{
							$('#btnAddrecord').html('Update Record');
							showAlertRedirect("Success","Record Updated Successfully","success","pgContactFieldMaster.php");
						}
						$("#txtContactType").val("");
						$("#txtselcontact").val("");
						$("#txtduplicate").val("");
