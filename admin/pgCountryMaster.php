              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Country Master</h4>
					<button type="button" class="btn btn-link btn-rounded btn-fw float-right" onclick="location.href='pgCountryMasterForm.php?type=add&id=';"><i class="icon-plus"></i> Create New Record</button>
...
function editRecord(id){
	window.location.href = "pgCountryMasterForm.php?type=edit&id="+id;
}
...
{
	var valtablename="tw_country_master";
		$.ajax({
			type:"POST",
