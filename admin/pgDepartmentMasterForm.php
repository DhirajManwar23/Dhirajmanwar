                ...
                <div class="card-body">
                  ...
                  <div class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtDepartmentName" maxlength="20"  value="<?php echo $department_name; ?>"placeholder="Department Name" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="txtDescription" maxlength="1000"   placeholder="Description"><?php echo $description; ?></textarea>
                    </div>
					    <div class="form-group">
...
function addrecord(){
		var buttonHtml = $('#btnAddrecord').html();
		 if(!validateBlank($("#txtDepartmentName").val())){
			setErrorOnBlur("txtDepartmentName");
		  }
				...
				success:function(response){
					...
					if($.trim(response)=="Success"){
						if(valrequesttype=="add"){
							...
							showAlertRedirect("Success","Record Added Successfully","success","pgDepartmentMaster.php");
							}
						else{
							$('#btnAddrecord').html('Update Record');
							showAlertRedirect("Success","Record Updated Successfully","success","pgDepartmentMaster.php");
						}
