                  ...
                  <h4 class="card-title">Document Verification Status Master</h4>
					  <div class="forms-sample">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" id="txtDocumentStatus" maxlength="20" placeholder="Document Status" value="<?php echo $document_status; ?>" />
						</div>
						<div class="form-group">
						  <label for="txtPriority">Priority <code>*</code></label>
						  <input type="number" class="form-control" id="txtPriority" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;" placeholder="Priority" value="<?php echo $priority; ?>" />
						</div>
						<div class="form-group">
...
function addrecord(){
		var buttonHtml = $('#btnAddrecord').html();
		 if(!validateBlank($("#txtDocumentStatus").val())){
			setErrorOnBlur("txtDocumentStatus");
		  }
				...
				success:function(response){
					...
					if($.trim(response)=="Success"){
						if(valrequesttype=="add"){
							...
							showAlertRedirect("Success","Record Added Successfully","success","pgDocumentVerificationStatusMaster.php");
							}
						else{
							$('#btnAddrecord').html('Update Record');
							showAlertRedirect("Success","Record Updated Successfully","success","pgDocumentVerificationStatusMaster.php");
						}
