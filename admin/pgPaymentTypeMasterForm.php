...
if($requesttype=="edit"){
	...
	$qry = "SELECT payment_type_value,priority,description,visibility from tw_payment_type_master WHERE id = ".$id." ";
	$retVal = $sign->FunctionJSON($qry);
	$decodedJSON = json_decode($retVal);
	$payment_type_value	 = $decodedJSON->response[0]->payment_type_value;
...
<title>Trace Waste | Payment Type Master</title>
<!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Payment Type Master</h4>
					  <div class="forms-sample">
						<div class="form-group">
						  <label for="txtPaymentType">Payment Type <code>*</code></label>
						  <input type="text" class="form-control" id="txtPaymentType" maxlength="20" value="<?php echo $payment_type_value; ?>" placeholder="Payment Type" />
						</div>
						<div class="form-group">
...
function addrecord(){
		...
		if(!validateBlank($("#txtPaymentType").val())){
			setErrorOnBlur("txtPaymentType");
		  }
			...
			$.ajax({
				type:"POST",
				url:"apiAddPaymentTypeMasterStatus.php",
				data:{payment_type_value:$("#txtPaymentType").val(),priority:$("#txtPriority").val(),description:$("#txtDescription").val(),visibility:$('#chkVisibility').prop('checked')},
				success:function(response){
					...
					if($.trim(response)=="Success"){
						if(valrequesttype=="add"){
							...
							showAlertRedirect("Success","Record Added Successfully","success","pgPaymentTypeMaster.php");
							}
						else{
							$('#btnAddrecord').html('Update Record');
							showAlertRedirect("Success","Record Updated Successfully","success","pgPaymentTypeMaster.php");
						}
						$("#txtPaymentType").val("");
						$("#txtPriority").val("");
						$("#txtDescription").val("");
