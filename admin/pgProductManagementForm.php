...
function addrecord(){
		  ...
		  if(!validateBlank($("#txtcategoryname").val())){
			...
			if(valrequesttype=="add"){
				var valquery = "insert into tw_product_management(category,sub_category,product_name,product_type,amount_per_unit,uom,tax,opening_quantity,threshold,public_visible,hsn,created_by,created_on,created_ip)values('"+$("#txtcategoryname").val()+"','"+$("#txtsubcategoryname").val()+"','"+$("#txtProductName").val()+"','"+$("#txtProductType").val()+"','"+$("#txtAmountPerUnit").val()+"','"+$("#txtUom").val()+"','"+$("#txtTax").val()+"','"+$("#txtOpeningQuantity").val()+"','"+$("#txtThreshold").val()+"','"+$('#chkVisibility').prop('checked')+"','"+$("#txtHSN").val()+"','"+valcreated_by+"','"+valcreated_on+"','"+valcreated_ip+"')";
				var valquerycount = "select count(*) as cnt from tw_product_management where product_name = '"+$("#txtProductName").val()+"'";
			}
			else{
				...
				var valquerycount = "select count(*) as cnt from tw_product_management where product_name = '"+$("#txtProductName").val()+"' and ID!='"+valrequestid+"'";
