                ...
                <div class="card-body">
                  ...
                  <div class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtUserType" maxlength="20" value="<?php echo $user_type; ?>" placeholder="User Type" />
                    </div>
                    <div class="form-group">
...
function addrecord(){
	 if(!validateBlank($("#txtUserType").val())){
			setErrorOnBlur("txtUserType");
		  }
			...
			$.ajax({
				...
				data:{user_type:$("#txtUserType").val(),priority:$("#txtPriority").val(),description:$("#txtDescription").val(),visibility:$('#chkVisibility').prop('checked')},
				...
				console.log(response);
					...
					if($.trim(response)=="Success"){
						...
						showAlertRedirect("Success","Record Added Successfully","success","pgUserTypeMaster.php");
						}
						else{
							$('#btnAddrecord').html('Update Record');
							showAlertRedirect("Success","Record Updated Successfully","success","pgUserTypeMaster.php");
						}
						$("#txtUserType").val("");
						$("#txtPriority").val("");
						$("#txtDescription").val("");
