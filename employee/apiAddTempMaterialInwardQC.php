...
$txtNorms=$_POST["txtNorms"];
$txtFirst=$_POST["txtFirst"];
$txtSecond=$_POST["txtSecond"];
$txtThird=$_POST["txtThird"];
$txtTotal=$_POST["txtTotal"];
$txtAverage=$_POST["txtAverage"];
$employee_id=$_SESSION["employee_id"];

$ip_address= $commonfunction->getIPAddress();
date_default_timezone_set("Asia/Kolkata");
$cur_date=date("Y-m-d h:i:sa");
$qry="insert into tw_material_inward_qc_temp (employee_id,description,norms,first,second,third,total,average,created_by,created_on,created_ip) values('".$employee_id."','".$selDescription."','".$txtNorms."','".$txtFirst."','".$txtSecond."','".$txtThird."','".$txtTotal."','".$txtAverage."','".$employee_id."','".$cur_date."','".$ip_address."')";
