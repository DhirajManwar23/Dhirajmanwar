...
$qry1="Select count(*) as cnt from tw_outward_data_entry where entry_date BETWEEN '".$StartDate."' AND  '".$EndDate."'  AND ward='".$Ward."'";
...
$table.="<thead><tr><th>#</th><th>Date</th><th>Customer Name</th><th>Material Name</th><th>Quantity</th></tr></thead><tbody>";
