...
$returnADD="";
 ...
 if ($address_id==$valBillid)
 {
 	$is_checkedbill="checked='checked'";
 }
...
$returnADD.="<div class='col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12'><div class='card'><div class='card-body'><h4 class='card-title'><a href='javascript:void(0)' onclick='saveAdd(".$address_id.",".$addPass.")'> <input type='radio' id='radBillAddress' class='radAddress' name='radBillAddress' value=".$address_id." ".$is_checkedbill." ></a> <i class=".$address_icon."></i> ".$address_type_value."</h4><p>".$address."</p></div></div></div>";
//$returnADD.=$i;
 $i=$i+1;
}
...
$currency= $sign->SelectF($currencyQry,"currency");
 ...
 array_push($CompanyDetails,$returnADD,$google_map,$currency);
