...
if($type=="add" || $type=="edit"){
	...
	$qry="select id,aggeragator_name,gst,grn_number,type_of_submission,grnfile,purchase_invoice_number,purchase_invoice_date,dispatched_state,dispatched_place,invoice_quantity,invoicefile,plant_quantity,aggregator_wbs_number,aggregator_wbs_date,wbsfile,plant_wbs_number,plant_wbs_date,pwbsfile,vehicle_number,vehiclefile,eway_bill_number,ewayfile,lr_number,lr_date,lrfile,reason,category_name,material_name from tw_temp where po_id = '".$po_id."' and status='".$settingValueAwaitingStatus."' order by id Asc";
...
$it=1;
if($type=="add" || $type=="edit"){
	$table.="<thead><tr><th>#</th><th>Aggregator Name</th><th>GST</th><th>Category Name</th><th>Material Name</th><th>GRN Number</th><th>Type Of Submission</th><th>GRN File</th><th>Purchase Invoice Number</th><th>Purchase Invoice Date</th><th>Dispatched State</th><th>Dispatched Date</th><th>Invoice Quantity</th><th>Invoice File</th><th>Plant Quantity</th><th>Aggregator WBS No</th></th><th>Aggregator WBS Date</th></th><th>WBS File</th></th><th>Plant WBS No</th></th><th>Plant WBS Date</th></th><th>Plant WBS File</th></th><th>Vehicle No</th><th>Vehicle Photo</th><th>Eway Bill No</th><th>Eway File</th><th>LR Number</th><th>LR Date</th><th>LR File</th><th>Save</th><th>View Record</th></tr></thead><tbody>";
}
else if($type=="query"){
	$table.="<thead><tr><th></th><th>#</th><th>Aggregator Name</th><th>GST</th><th>Category Name</th><th>Material Name</th><th>GRN Number</th><th>Type Of Submission</th><th>GRN File</th><th>Purchase Invoice Number</th><th>Purchase Invoice Date</th><th>Dispatched State</th><th>Dispatched Date</th><th>Invoice Quantity</th><th>Invoice File</th><th>Plant Quantity</th><th>Aggregator WBS No</th></th><th>Aggregator WBS Date</th></th><th>WBS File</th></th><th>Plant WBS No</th></th><th>Plant WBS Date</th></th><th>Plant WBS File</th></th><th>Vehicle No</th><th>Vehicle Photo</th><th>Eway Bill No</th><th>Eway File</th><th>LR Number</th><th>LR Date</th><th>LR File</th><th>Edit</th><th>View Record</th></tr></thead><tbody>";
}
else if($type=="accept"){
	...
	$table.="<thead><tr><th>#</th><th>Aggregator Name</th><th>GST</th><th>Category Name</th><th>Material Name</th><th>GRN Number</th><th>Type Of Submission</th><th>GRN File</th><th>Purchase Invoice Number</th><th>Purchase Invoice Date</th><th>Dispatched State</th><th>Dispatched Date</th><th>Invoice Quantity</th><th>Invoice File</th><th>Plant Quantity</th><th>Aggregator WBS No</th></th><th>Aggregator WBS Date</th></th><th>WBS File</th></th><th>Plant WBS No</th></th><th>Plant WBS Date</th></th><th>Plant WBS File</th></th><th>Vehicle No</th><th>Vehicle Photo</th><th>Eway Bill No</th><th>Eway File</th><th>LR Number</th><th>LR Date</th><th>LR File</th><th>Edit</th><th>Delete</th><th>View Record</th></tr></thead><tbody>";
}
