...
$requesttype=$sign->escapeString($_POST["requesttype"]);
...
while($x>=$i){
	...
	$count=$count+1;
		...
		$table.="<td class='text-center'><a href='pgViewTableRecord.php?type=edit/".$requesttype."&id=".$id."'  id='alink'><i class='ti-home'></a></td>";
