...
$qry="select po_id as id,requester_company_id,recycler_company_id,total_quantity,reason,date,status from  tw_epr_material_assign_info where requester_company_id='".$company_id."' AND status='".$settingValueRejectedStatus."' order by id desc";
$retVal = $sign->FunctionJSON($qry);

$qry1="select count(*) as cnt from tw_epr_material_assign_info where requester_company_id='".$company_id."' AND status='".$settingValueRejectedStatus."'";
