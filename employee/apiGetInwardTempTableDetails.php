...
$qry="select material_id,quantity,tax,rate,total from tw_material_outward_individual WHERE material_outward_id='".$hdnOrderID."' ORDER BY id Asc";
$retVal = $sign->FunctionJSON($qry);

$qry1="Select count(*) as cnt from tw_material_outward_individual where material_outward_id='".$hdnOrderID."'";
...
while($x>=$i){
	...
	$qry2="insert into tw_material_outward_temp (employee_id,material_id,quantity,hsn,tax,rate,total,created_by,created_on,created_ip) values('".$employee_id."','".$material_id."','".$quantity."','".$quantity."','".$tax."','".$rate."','".$total."','".$employee_id."','".$cur_date."','".$ip_address."')";
...
$table.="<thead>
<tr><th>#</th><th>Material Name</th><th>Quantity</th><th>HSN</th><th>Tax(%)</th><th>Rate</th><th>Amount</th><th>TotalGST</th>
<th>Total</th></tr></thead><tbody>";

/* <tr><th>#</th><th>Material Name</th><th>Quantity</th><th>Tax(%)</th><th>Rate</th><th>TotalGST</th><th>Amount</th><th>Total</th></tr> */
	while($x>=$i){
