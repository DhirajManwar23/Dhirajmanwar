...
$qry="SELECT mo.id,cd.CompanyName,mo.total_quantity,mo.final_total_amout FROM tw_material_outward mo INNER JOIN tw_company_details cd ON mo.customer_id = cd.ID WHERE mo.company_id = '".$company_id."'  and mo.status='".$settingValueApprovedStatus."' ORDER BY mo.id DESC";
$retVal = $sign->FunctionJSON($qry);
$decodedJSON2 = json_decode($retVal);


$qry1="Select count(*) as cnt from tw_material_outward where company_id='".$company_id."' and status='".$settingValueApprovedStatus."'";
