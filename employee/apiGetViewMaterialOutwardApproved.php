...
$qry="SELECT mo.id,mo.customer_id,cd.CompanyName,cd.Status,cd.Company_Logo,mo.total_quantity,mo.final_total_amout,supplier_geo_location,receiver_geo_location FROM tw_material_outward mo INNER JOIN tw_company_details cd ON mo.customer_id = cd.ID WHERE mo.employee_id = '".$employee_id."' and mo.po_id  = '".$po_id."' and mo.status='".$settingValueApprovedStatus."' ORDER BY mo.id DESC";
