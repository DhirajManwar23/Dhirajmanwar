...
$qry="SELECT mo.id,cd.CompanyName,mo.final_total_amout,mo.total_quantity FROM tw_material_outward mo INNER JOIN tw_company_details cd ON mo.customer_id = cd.ID WHERE mo.employee_id = '".$employee_id."' and mo.po_id = '".$po_id."' and mo.status='".$settingValueRejectedStatus."' ORDER BY mo.id DESC";
...
$table.="
	...
	$table.="<thead><tr><th>#</th><th>Customer Name</th><th>Total Amount</th><th>Total Quantity</th><th>Reason</th><th>Document</th></tr></thead><tbody>";
		while($x>=$i){
