...
<?php
	...
	$table="";
	$it=1;
	$table.="<thead class='text-center'><tr><th>#</th><th>Transaction ID</th><th>Amount</th><th>Payment Date</th><th>Edit</th><th>Delete</th></tr></thead><tbody>";
	...
	$payment_date = date("d-m-Y h:i:sa", strtotime($payment_date));
		...
		$table.="<td class='text-center'><a href='javascript:void(0)' onclick='editRecord(".$id.")'>Edit</a></td>";
		$table.="<td class='text-center'><a href='javascript:void(0)' onclick='deleteRecord(".$id.")'>Delete</a></td>";
		$it++;
		$table.="</tr>";
