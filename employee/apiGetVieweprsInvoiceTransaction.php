...
<?php
	...
	$qry="select id,invoice_id,transaction_id,amount,payment_date,po_id from tw_invoice_transaction_eprs where customer_id='".$company_id."' and po_id='".$valpoi_id."'";
	
	$retVal = $sign->FunctionJSON($qry);

	$qry1="Select count(*) as cnt from tw_invoice_transaction_eprs where customer_id='".$company_id."'";
