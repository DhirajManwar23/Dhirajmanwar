...
if($sID=="0"){
	...
	$varCondition="and customer_id='".$sID."'";
...
where material_outward_id in (select id from tw_material_outward where company_id='".$company_id."' and status='".$settingValueApprovedStatus."' ".$varCondition.") and created_on>='2022-04-01' and created_on<='2023-03-31'";
