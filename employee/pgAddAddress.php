...
if($requesttype=="add"){
	$queryinitialcount = "Select count(*) as cnt from tw_employee_address where employee_id = '".$created_by."'";
                  ...
                  <h4 class="card-title">Address Details</h4>
					<div class="forms-sample">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
							<input type="number" class="form-control form-control-sm" id="txtPincode" onchange="myFunction(this.value)" value="<?php echo $pincode; ?>" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==6) return false;"  placeholder="Pincode">
							</div>
						</div>
						<div class="form-group row">
...
var valrequesttype = "<?php echo $requesttype;?>";
  ...
  function adddata(){
		var buttonHtml = $('#btncreate').html();
		  ...
		  else if(!isNumber($("#txtPincode").val())){
			setError(txtPincode);
		  } 
			  ...
			  {
				var valemployee_id = "<?php echo $created_by;?>";
			  //--Default Address
