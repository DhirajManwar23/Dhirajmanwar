...
function adddata(){
	...
	var number=$("#txtValue").val();
	  ...
	  else if(textFieldValue==valsettingValuePfax){
	   if(!isNumber($("#txtValue").val())){
	   setErrorOnBlur("txtValue");
	   doExe=false;
		}
	...
	else if(textFieldValue==valsettingValuePemail || textFieldValue==valsettingValuePotherEmail || textFieldValue==valsettingValuePotherContact)
	  {
		  if(!validateEmail($("#txtValue").val())){
		   setErrorOnBlur("txtValue");
