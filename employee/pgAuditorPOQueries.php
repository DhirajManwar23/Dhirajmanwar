...
$qryGetAuditorPO = "select po_id as AuditorPOID from tw_auditor_po_details where status = '".$settingValueRejectedStatus."'";
$AuditorPOID = $sign->SelectF($qryGetAuditorPO,'AuditorPOID');
?>
<!DOCTYPE html>
<html lang="en">
...
var valpoid='<?php echo $AuditorPOID;?>';
var valRejectionId = "";
...
function showData(valtype){
	...
	$.ajax({
		...
		data:{type:valtype,poid:valpoid},
...
function ViewFullfilment(id){
	window.location.href = "pgEPRSFullfilment.php?id="+id;
}
function ViewFullfilmentRecords(id){
	window.location.href = "pgEPRSDocumentUpload.php?type=view&id="+id;
}
function ViewFullfilmentAcceptRecords(id){
	window.location.href = "pgEPRSDocumentUpload.php?type=accept&id="+id;
}
function ViewFullfilmentPendingRecords(id){
	window.location.href = "pgEPRSDocumentUpload.php?type=edit&id="+id;
}
function ViewFullfilmentRejectedRecords(id){
	window.location.href = "pgEPRSDocumentUpload.php?type=query&id="+id;
}
