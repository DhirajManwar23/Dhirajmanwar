...
<title>Trace Waste |Outward</title>
<!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">			  
                <div class="card-body">				
                  <h4 class="card-title">Outward</h4>
					<button type="button" class="btn btn-link btn-rounded btn-fw float-right" onclick="location.href='pgOutwardForm.php?type=add&id=';"><i class="icon-plus"></i> Create New Record</button>
...
function editRecord(id){
	window.location.href = "pgOutwardForm.php?type=edit&id="+id;
}
		...
		$.ajax({
				...
				success:function(response){
					if($.trim(response)=="Success"){
						showData();
						showAlertRedirect("Success","Record Deleted Successfully","success","pgOutward.php");
					}
					else{
