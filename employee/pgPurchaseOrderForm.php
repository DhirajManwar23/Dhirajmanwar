...
$Main_address_bill.="<div class='col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12'>
              <div class='card'>
                <div class='card-body'>
					<h4 class='card-title'><a href='javascript:void(0)' onclick='saveBillToAddress(".$id.",".$addPass.")'> <input type='radio' id='radAddressBill' class='radAddress' name='radAddressBill' value='".$id."' ".$is_checked." ></a> <i class=".$address_icon."></i> ".$address_type_value."</h4>
					<p>".$address."</p>
                </div>
              </div>
            </div>";
$Main_address_ship.="<div class='col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12'>
              <div class='card'>
                <div class='card-body'>
					<h4 class='card-title'><a href='javascript:void(0)' onclick='saveShipToAddress(".$id.",".$addPass.")'> <input type='radio' id='radAddressShip' class='radAddress' name='radAddressShip' value='".$id."' ".$is_checked." ></a> <i class=".$address_icon."></i> ".$address_type_value."</h4>
					<p>".$address."</p>
                </div>
              </div>
            </div>";
	  ...
	  <div class="row">
		<div class="col-md-12 grid-margin stretch-card">
		  <div class="card">
			...
			<div class="row">
				<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12">
				  <label for="txtINVOICINGMETHOD">Invoicing Method<code>*</code></label>
					<select id="txtINVOICINGMETHOD" class="form-control">
					<option value="">Select Invoicing Method</option>
			...
			<div class="row ">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
					  ...
					  <select  class="form-control" id="selcity" onchange="loadCountry();" placeholder="city">
						<option value="">Choose...</option>
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
					 ...
					 <input type="text" class="form-control" id="txtUnit" readonly value="Kg" placeholder="Unit" />
					</div>
						<div class="form-group col-md-4">
	...
	if(!validateBlank($("#textPONumber").val())){
		...
		$.ajax({
			...
			success:function(response){	
				if($.trim(response)=="Success"){
					AddSupplierNo();
						showAlertRedirect("Success","Data Added Successfully","success","pgEprPo.php?type=In%20Process");
...
function creatnewPo(){
	var company_id = "<?php echo $company_id; ?>";
	var supplier_id=$('#txtSupplierName').val();
	var EMP_EMAIL= "<?php echo $EMP_EMAIL; ?>";
	console.log(EMP_EMAIL);
	$.ajax({
		type:"POST",
		url:"apiNewEprPo.php",
		data:{company_id:company_id,supplier_id:supplier_id,EMP_EMAIL:EMP_EMAIL},
		 success:function(response){
			  console.log(response);
