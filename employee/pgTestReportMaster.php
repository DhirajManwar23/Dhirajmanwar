              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Test Report Master</h4>
					<button type="button" class="btn btn-link btn-rounded btn-fw float-right" onclick="location.href='pgTestReportMasterForm.php?type=add&id=';"><i class="icon-plus"></i> Create New Record</button>
...
function editRecord(id){
	window.location.href = "pgTestReportMasterForm.php?type=edit&id="+id;
}
