...
<title>Trace Waste | Transporter Master </title>
<!-- plugins:css -->
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Transporter Master</h4>
					<button type="button" class="btn btn-link btn-rounded btn-fw float-right" onclick="location.href='pgTransportMasterForm.php?type=add&id=';"><i class="icon-plus"></i> Create New Record</button>
...
$(document).ready(function(){
	...
	function showData(){
		$.ajax({
			type:"POST",
			url:"apiGetViewTransportMaster.php",
			data:{},
...
function showKYC(id){
	window.location.href = "pgKycDetails.php?tid="+id;
}
	
function showVehicles(id){
	window.location.href = "pgVehicleDetails.php?tid="+id;
}
