        ...
        <div class="content-wrapper">
		  ...
		  <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
             ...
             <div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="ti-dashboard menu-icon"></i> Eway (<?php echo $retValii; ?>)</h4>
					<?php
		   ...
		   <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
             ...
             <div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="ti-dashboard menu-icon"></i> Invoice (<?php echo $retVali; ?>)</h4>
					<?php
		  ...
		  <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
             ...
             <div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="ti-dashboard menu-icon"></i> Weigh Bridge Slip (<?php echo $retValiii; ?>)</h4>
					<?php
		  ...
		  <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
             ...
             <div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="ti-dashboard menu-icon"></i> Photos (<?php echo $retValvi; ?>)</h4>
					<?php
		  ...
		  <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
             ...
             <div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="ti-dashboard menu-icon"></i> Goods Received Note (<?php echo $retValiv; ?>) <?php if($type=="In Process"){ ?><div class="float-right"><a href="pgMaterialInwardAttachDocument.php?type=GRN&id=<?php echo $outward_id; ?>"><small><i class="ti-clip"></i> Attach</small></a> | <a href="pgInwardGRN.php?inward_id=<?php echo $outward_id; ?>" ><small><i class="ti-plus"></i> Generate</small></a></div><?php } ?></h4>
		  ...
		  <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
             ...
             <div class="card">
				<div class="card-body">
					<h4 class="card-title"><i class="ti-dashboard menu-icon"></i> Quality Certificate (<?php echo $retValv; ?>)<?php if($type=="In Process"){ ?> <div class="float-right"><a href="pgMaterialInwardAttachDocument.php?type=QC&id=<?php echo $outward_id; ?>"><small><i class="ti-clip"></i> Attach</small></a> | <a href="pgInwardQualityCheck.php?inward_id=<?php echo $outward_id; ?>" ><small><i class="ti-plus"></i> Generate</small></a></div><?php } ?></h4>
					<?php
