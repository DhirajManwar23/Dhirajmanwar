...
$qry = "SELECT carrier_no,party_name,material_name,gross_weight,gross_weight_date_time,tare_weight,tare_weight_date_time,net_weight,amount_received,driver_name,payment_mode,created_on from  tw_material_outward_wbs WHERE id = ".$wbsid." ";
...
$created_on = $decodedJSON->response[11]->created_on;
