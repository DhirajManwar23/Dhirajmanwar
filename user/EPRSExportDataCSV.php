...
while($x>=$i){
	...
	$lineData = array($it,$po_number,$company_name,$aggeragator_name,$gst,$category_name,$material_name,$grn_number,$type_of_submission,$purchase_invoice_number,$purchase_invoice_date,$dispatched_state,$dispatched_place,$invoice_quantity,$plant_quantity,$aggregator_wbs_number,$aggregator_wbs_date,$plant_wbs_number,$plant_wbs_date,$vehicle_number,$eway_bill_number,$lr_number,$lr_date);	
