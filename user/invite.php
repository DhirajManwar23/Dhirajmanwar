...
$Senderqry2="SELECT CompanyName FROM tw_company_details WHERE ID='".$sender_id."'";
$SenderName= $sign->SelectF($Senderqry2,"CompanyName");
...
if($retVal==0){
	...
	if($retVal1=="Success"){
      ...
      $message3 = str_replace("_COMPANYNAME_",$SenderName,$message1);
	  $message4 = str_replace("_LINK_",$settingValueUserUrl,$message3);
	  fclose($myfile);						
      $mail_response = $mailobj->Mailsend($retval3,$subject,$message4);
