...
$settingValueCompanyPanel="";
$settingValueRejectedStatus= $commonfunction->getSettingValue("Rejected status");

$qryMenuQueryCnt="SELECT count(*) as cnt FROM tw_po_info pi INNER JOIN tw_temp tt ON tt.po_id=pi.id WHERE pi.supplier_id='".$company_id."' and tt.status='".$settingValueRejectedStatus."'";
$retQueryCount = $sign->Select($qryMenuQueryCnt);


if ($company_type=="EPR")
{
	$settingValueCompanyPanel=$commonfunction->getSettingValue("EPRServices");
}
else
{
