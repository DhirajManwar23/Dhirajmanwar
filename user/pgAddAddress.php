...
$qry1 = "select id,address_type_value from tw_address_type_master where visibility = 'true' ORDER by priority,id, address_type_value  ASC";
...
<title>Trace Waste | Address Details</title>
<!-- plugins:css -->
                ...
                <div class="card-body">
                  ...
                  <div class="forms-sample">
                   <div class="form-group row">
					...
					<div class="form-group row">
                      <label for="AddressLine2" class="col-sm-3 col-form-label">Address Line 2 (Optional)</label>
                      <div class="col-sm-9">
		...
		if(valrequesttype=="add"){
			...
			success:function(response){
				console.log(response);
					if($.trim(response)=="Success"){
					if(valrequesttype=="add"){
						showAlertRedirect("Success","Address Added Successfully","success","pgCompanyProfile.php?id="+valcompany_id);
						enableButton('#btncreate','Add');
					}
					else{
						showAlertRedirect("Success","Address Updated Successfully","success","pgCompanyProfile.php?id="+valcompany_id);
