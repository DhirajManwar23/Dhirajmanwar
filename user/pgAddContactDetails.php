 ...
 if(!validateBlank($("#txtValue").val())){
	...
	if (doExe){
		...
		if(valrequesttype=="add"){
			var valquery = "insert into tw_company_contact(company_id,contact_field,value,public_visible,status,created_by,created_on,created_ip)values('"+valcreated_by+"','"+$("#selContactField").val()+"','"+$("#txtValue").val()+"','"+$('#chkVisibility').prop('checked')+"','"+valsettingValueDocumentStatus+"','"+valcreated_by+"','"+valcreated_on+"','"+valcreated_ip+"')";
			...
			var valquery = "Update tw_company_contact set contact_field = '"+$("#selContactField").val()+"' , status='"+valsettingValueDocumentStatus+"', value ='"+$("#txtValue").val()+"', public_visible = '"+$('#chkVisibility').prop('checked')+"',modified_by='"+valcreated_by+"',modified_on='"+valcreated_on+"',modified_ip='"+valcreated_ip+"' where id = '"+valrequestid+"' ";
		...
		success:function(response){
				...
				if(valrequesttype=="add"){
					...
					if(valrequesttype=="add"){
						showAlertRedirect("Success","Contact Added Successfully","success","pgCompanyProfile.php");
					}
					else{
						showAlertRedirect("Success","Contact Updated Successfully","success","pgCompanyProfile.php");
					}
				}
