...
$qry="SELECT count(*) as cnt FROM tw_verify_email where email='".$dec_email."' and token='".$dec_token."' and  user_type='Company' and status='".$settingValueExpiredStatus."' ";
$sign=new Signup();
...
<script>
 $(document).ready(function(){
	...
	if(valretVal>0){
		...
		var valquery="update tw_company_contact SET status='"+valsettingValueVerifiedStatus+"' WHERE  value='"+valdec_email+"'";
