              ...
              <div class="card">			  
                <div class="card-body">			
                  <h4 class="card-title">Digital Signature</h4>
					<button type="button" class="btn btn-link btn-rounded btn-fw float-right" onclick="location.href='pgDigitalSignatureform.php?type=add&id=';"><i class="icon-plus"></i> Create New Record</button>
...
function editRecord(id){
	window.location.href = "pgDigitalSignatureform.php?type=edit&id="+id;
}
...
{
	var valtablename="tw_digital_signature ";
