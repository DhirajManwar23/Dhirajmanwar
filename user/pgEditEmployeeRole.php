...
<title>Trace Waste | Employee Role</title>
<!-- plugins:css -->
...
function addrecord(){
	disableButton('#btnAddrecord','<i class="ti-timer"></i> Processing...');
		...
		var valquery = "Update tw_employee_registration set employee_department='"+$("#txtEmployeedept").val()+"',employee_designation='"+$("#txtEmployeeDesignation").val()+"',employee_role='"+$("#txtEmployeeRole").val()+"',modified_by='"+valcreated_by+"',modified_on='"+valquery+"',modified_ip='"+valcreated_ip+"' where id="+empid;
