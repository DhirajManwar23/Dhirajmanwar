...
<title>Trace Waste | QC Patameters</title>
<!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">QC Parameters</h4>
                  <div class="forms-sample">
						<div class="form-group">
						  <label for="txtdescription">Description <code>*</code></label>
						  <input type="text" class="form-control" id="txtdescription" maxlength="1000" placeholder="Description" value="<?php echo $description; ?>">
						</div>
						<div class="form-group">
						  <label for="txtnorms">Norms <code>*</code></label>
						  <input type="email" class="form-control" id="txtnorms" maxlength="100" value="<?php echo $norms; ?>" placeholder="Norms" />
						</div>
						<div class="form-group">
	...
	if(!validateBlank($("#txtdescription").val())){
		...
		var valquerycount="";
			if(valrequesttype=="add"){
				...
				valquerycount = "select count(*) as cnt from tw_test_report_designation_master where description='"+$("#txtdescription").val()+"'  and company_id='"+companyID+"' ";
				...
				valquerycount = "select count(*) as cnt from tw_test_report_designation_master where description='"+$("#txtdescription").val()+"' and company_id='"+companyID+"' and ID!='"+valrequestid+"'";
			} 
				...
				$.ajax({
						...
						success:function(response){
							...
							if($.trim(response)=="Success"){
								if(valrequesttype=="add"){
									showAlertRedirect("Success","Record Added Successfully","success","pgQCParameters.php");
								}
								else{
									showAlertRedirect("Success","Record Updated Successfully","success","pgQCParameters.php");
								}
							}
